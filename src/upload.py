...
def usage(error=None):
    if error:
        ...
        print(error)
    print('-'*80)
    print('This program scans the directory and all sub-directories pointed to and containined within the directory [root] for files ending in the file extension [ext] and attempts to upload their contents to MongoDB on localhost to the [coll] collection.')
    print('The collection is stored in the database pointed to by [db].')
